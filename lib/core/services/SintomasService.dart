...
class SintomasService {
  ...
  Future<Database> _initDatabase() async {
    ...
    return await openDatabase(
      ...
      onCreate: (db, version) async {
        ...
        ''');
        await db
            .execute('CREATE INDEX idx_sintomas_id ON sintomas(id_sintomas)');
      },
    );
  }
  ...
  Future<List<Map<String, dynamic>>> _getAllSintomasLocal() async {
    try {
      ...
      final List<Map<String, dynamic>> maps =
          await db.query('sintomas', orderBy: 'nombre ASC');
      return maps;
    } catch (e) {
  ...
  Future<void> _insertMultipleSintomas(
      List<Map<String, dynamic>> sintomasList) async {
    try {
      final db = await database;
  ...
  Future<Map<String, dynamic>> agregarSintoma(
      Map<String, dynamic> nuevoSintoma) async {
    try {
        ...
        await _insertMultipleSintomas([
          {
            ...
            'activo': nuevoSintomaData['activo']
                ? 1
  ...
  Future<Map<String, dynamic>> actualizarSintoma(
      int idSintoma, Map<String, dynamic> sintomaActualizado) async {
    try {
        ...
        await _insertMultipleSintomas([
          {
            ...
            'usuario_modificacion':
                sintomaActualizadoData['usuario_modificacion'],
