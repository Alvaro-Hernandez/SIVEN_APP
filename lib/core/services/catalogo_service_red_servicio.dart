...
class CatalogServiceRedServicio {
  ...
  Future<Map<String, dynamic>> getSilaisById(int id) async {
    final response = await httpService
        .get('$BASE_URL$CATALOGOS_RED_DE_SERVICIO/silais/$id');
    return jsonDecode(response.body) as Map<String, dynamic>;
  }

  // Crear un nuevo SILAIS
  Future<Map<String, dynamic>> createSilais(
      Map<String, dynamic> silais) async {
  ...
  Future<List<dynamic>> getAllEstablecimientos() async {
    final response = await httpService.get(
        '$BASE_URL$CATALOGOS_RED_DE_SERVICIO/list-establecimientos');
  ...
  Future<Map<String, dynamic>> getEstablecimientoById(int id) async {
    final response = await httpService.get(
        '$BASE_URL$CATALOGOS_RED_DE_SERVICIO/establecimiento/$id');
    return jsonDecode(response.body) as Map<String, dynamic>;
  }
