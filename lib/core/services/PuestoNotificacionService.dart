...
class PuestoNotificacionService {
  ...
  Future<Map<String, dynamic>> crearPuestoNotificacion(
    ...
    if (response.statusCode == 201 || response.statusCode == 200) {
      ...
      throw Exception(
          'Error al crear el puesto de notificación: ${response.statusCode}');
    }
  }
  ...
  Future<void> _fetchAndUpdatePuestosNotificacion() async {
    final response = await httpService
        .get('$BASE_URL/v1/catalogo/captacion/list-puesto-notificacion');
