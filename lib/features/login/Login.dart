      ...
      try {
        ...
        if (token != null && token.isNotEmpty) {
          ...
          await _storageService
              .savePasswordHash(password); // El hash se genera en el método
  ...
  Widget buildCustomTextField({
    ...
    return Container(
      decoration: BoxDecoration(
        borderRadius:
            BorderRadius.circular(12.0), // Redondeado para todo el contenedor
        border: Border.all(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.only(
                topLeft: Radius.circular(
                    10), // Igualar el redondeado del contenedor principal
                ...
                border: OutlineInputBorder(
                  borderRadius: BorderRadius.only(
                    topRight: Radius.circular(
                        12), // Asegura el redondeado de las esquinas derechas
                    bottomRight: Radius.circular(12),
                  ),
                  borderSide: BorderSide
                      .none, // Sin bordes visibles dentro del TextField
                ),
              ),
            ),
          ),
