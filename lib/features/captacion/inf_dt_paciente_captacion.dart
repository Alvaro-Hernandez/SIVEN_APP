                ...
                children: [
                  ...
                  Row(
                    children: const [
                      ...
                      SizedBox(width: 10),
                      Icon(Icons.copy, color: Color(0xFF00C1D4)),
                    ],
                  ),
                ],
              ),
                    ...
                    TableRow(
                      children: [
                        _PatientInfoRow(
                            ...
                            value: persona['codigo_expediente']?.toString() ??
                                'Sin dato'),
                        _PatientInfoRow(
                            label: 'Teléfono',
                            value:
                                persona['telefono']?.toString() ?? 'Sin dato'),
                      ],
                    ),
                    TableRow(
                      children: [
                        _PatientInfoRow(
                            label: 'Nº de cédula',
                            value:
                                persona['cedula']?.toString() ?? 'Sin cédula'),
                        _PatientInfoRow(
                            label: 'Estado civil',
                            value: persona['estado_civil']?.toString() ??
                                'Sin dato'),
                      ],
                    ),
                    TableRow(
                      children: [
                        _PatientInfoRow(
                            ...
                            value: persona['fecha_nacimiento']?.toString() ??
                                'Sin dato'),
                        _PatientInfoRow(
                            label: 'Etnia',
                            value: persona['grupo_etnico']?.toString() ??
                                'Sin dato'),
                      ],
                    ),
                    TableRow(
                      children: [
                        _PatientInfoRow(
                            label: 'Edad',
                            value: calcularEdad(persona['fecha_nacimiento']) ??
                                'Sin dato'),
                        _PatientInfoRow(
                            label: 'Ocupación',
                            value:
                                persona['ocupacion']?.toString() ?? 'Sin dato'),
                      ],
                    ),
                    TableRow(
                      children: [
                        _PatientInfoRow(
                            label: 'Sexo',
                            value: persona['sexo']?.toString() ?? 'Sin dato'),
                        _PatientInfoRow(
                    ...
                    TableRow(
                      children: [
                        _PatientInfoRow(
                            ...
                            value: persona['tipo_sangre']?.toString() ??
                                'Sin dato'),
                        _PatientInfoRow(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  IconButton(
                    icon: const Icon(Icons.add, color: Color(0xFF00C1D4)),
          ...
          DropdownButtonFormField<int>(
            ...
            onChanged: (int? value) {
              setState(() {
                ...
                selectedEventoNombre = widget.eventos.firstWhere(
                    (evento) => evento['id_evento_salud'] == value)['nombre'];
              });
            },
          ),
          const SizedBox(height: 20),
      ...
      actions: [
        Row(
          ...
          children: [
            ElevatedButton(
              onPressed: () {
                Navigator.pop(context); // Cerrar el diálogo sin retornar valor
              },
            ...
            ElevatedButton(
              onPressed: () {
                if (selectedEventoId != null && selectedEventoNombre != null) {
