...
class _CaptacionState extends State<Captacion> {
  ...
  void initializeServices() {
    ...
    resultadoDiagnosticoService =
        ResultadoDiagnosticoService(httpService: httpService);
  ...
  void didChangeDependencies() {
    ...
    if (!_cardsInitialized) {
      final int? idPersona = args != null && args is Map<String, dynamic>
          ? args['id_persona'] as int?
          : null;
      final int? idEventoSalud = args != null && args is Map<String, dynamic>
          ? args['id_evento_salud'] as int?
          : null;
      ...
      if (_currentCardIndex == 0) {
        ...
        if (primeraTarjetaState != null) {
          ...
          if (errors.isNotEmpty) {
            ...
            debugPrint('Datos de PrimeraTarjeta: $collectedData',
                wrapWidth: 1024);
          }
        }
        ...
        if (segundaTarjetaState != null) {
          ...
          if (errors.isNotEmpty) {
            ...
            debugPrint('Datos de SegundaTarjeta: $segundaData',
                wrapWidth: 1024);
            debugPrint('Datos recopilados hasta ahora: $collectedData',
                wrapWidth: 1024);
          }
        }
        ...
        if (terceraTarjetaState != null) {
          ...
          if (errors.isNotEmpty) {
            ...
            debugPrint('Datos de TerceraTarjeta: $terceraData',
                wrapWidth: 1024);
            debugPrint('Datos recopilados hasta ahora: $collectedData',
                wrapWidth: 1024);
          }
  ...
  Map<String, dynamic> _prepareDataForSaving(Map<String, dynamic> data) {
    return {
      ...
      'id_establecimiento_captacion':
          data['selectedEstablecimientoCaptacionId'],
      ...
      'id_establecimiento_diagnostico':
          data['selectedEstablecimientoDiagnosticoId'],
  ...
  void initState() {
    ...
    _controller.forward().whenComplete(() {
      Navigator.of(context)
          .pop(); // Cerrar el diálogo al finalizar la animación
    });
  }
