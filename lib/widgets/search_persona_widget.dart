...
class SearchPersonaWidget extends StatefulWidget {
  final Function(int)
      onPersonaSelected; // Callback para retornar el ID seleccionado

  const SearchPersonaWidget({Key? key, required this.onPersonaSelected})
      : super(key: key);
  ...
  Future<void> _buscarPersonas(String query) async {
    ...
    try {
      List<Map<String, dynamic>> resultados =
          await _personaService.buscarPersonasPorNombreOApellido(query);
      setState(() {
